...
public class NoteController{
	...
	public ResponseEntity<ViewNote> createNote(@RequestHeader String token, @RequestBody CreateNote newNote) throws NoteException {
	...
	public ResponseEntity<Response> updateNote(@RequestHeader String token, @PathVariable String noteId, @RequestBody UpdateNote updateNote) throws NoteException, NoteNotFoundException, UnauthorizedException{
	...
	public ResponseEntity<Response> deleteFromTrash(@RequestHeader String token, @PathVariable String noteId) throws NoteNotFoundException, UnauthorizedException{
	...
	public ResponseEntity<Response> emptyTrash(@RequestHeader String token) throws NoteNotFoundException{
		noteService.emptyNoteTrash(token);
